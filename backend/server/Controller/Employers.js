...
exports.afficherEmployer = function (res) {
    db.query('SELECT nom_employe,prenom_employe,etatCivil_employe,sexe_employe,adressePhysique_employe,dateNaissance_employe,email_employe,telephone_employe,departement.nom_departement FROM  employe,departement where employe.id_departement=departement.id_departement ', function (err, rows) {
        res.json(rows);
    });
}
